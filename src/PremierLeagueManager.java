...
public class PremierLeagueManager implements LeagueManager {
    ...
    public void deleteClub(String name) {
        //Reference: Case Study - Westminster car park
        if (clubList.isEmpty()) {
            System.out.println("No clubs is there!");
        } else {
        ...
        if(clubList.isEmpty()) {
            ...
            for (FootballClub club:clubList){
                if (club.getClubName().equals(clubName)){ //checking for club
                    ...
                    System.out.println("Played Matches: Total - "+club.getNoOfMatches()+" [ Wins: "+club.getWins()+" Loses: "+club.getLoses()+" Draws:"+club.getDraws()+" ]");
    ...
    public void TableDisplay() {
        ...
        if (clubList.isEmpty()){
            ...
            System.out.println("\n"+"| M - Matches Played | W - Wins| L - Loses| D - Draws| P - Point | GS - Goals Scored | GR - Goals Received | GD - Goal Difference |");
        }
    }
    ...
    public void addPlayedMatch (String home, String away, int homeScore, int awayscore,String date) {
        ...
        if (clubList.isEmpty()) { //Checking list is empty
            ...
            if (homeScore <= -1) {
                System.out.println("You have to enter number of goals(should be +)");
                return;
            }
